= GitHub Flavored Asciidoc (GFA) https://gist.github.com/dcode/0cfbf2699a1fe9b46ff04c41721dda74[原文地址]， https://asciidoctor.cn/docs/asciidoc-syntax-quick-reference/#document-header[原生语法参考]
ifdef::env-github[]
:imagesdir:
...
== What Next?
I'll add more comments here as I write and find interesting nuances. In the meantime, the http://asciidoctor.org[Asciidoctor project] has _GREAT_ http://asciidoctor.org/docs/user-manual/[user manual] and http://asciidoctor.org/docs/asciidoc-syntax-quick-reference/[Quick Reference]!
